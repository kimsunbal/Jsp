								...
								<div class="blog_text_inner">
									<div class="cat">
										<a class="cat_btn" href="#">${board.user.username}</a> <a
											...
											${board.createDate}</a> <a class="cat_btn" href="#">👁‍🗨
											‍${board.readCount}</a>
									</div>
									...
									<a class="blog_btn"
										href="/blog/board?cmd=detail&id=${board.id}">📄 Read More
									</a>
								</div>
							</div>
						</article>
						...
						<ul class="pagination">
							...
							<c:if test="${pagesplice>0}">
								<li class="page-item"><a
									href="/blog/board?cmd=list&page=${pagesplice}"
							...
							<c:forEach var="i" begin="1" end="5">
								<c:choose>
									...
									<c:when test="${param.page!=pagesplice+i}">
										<li class="page-item"><a
											href="/blog/board?cmd=list&page=${pagesplice+i}"
											class="page-link">${pagesplice+i}</a></li>
									</c:when>
									<c:otherwise>
							...
							<c:if test="${pagesplice+5<count}">
								<li class="page-item"><a
									href="/blog/board?cmd=list&page=${pagesplice+6}"
